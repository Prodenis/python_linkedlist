...
class ListTest(unittest.TestCase):
    ...
    def test_insert(self):
        ...
        test = s_list_insert.print_all_nodes()
        test1 = s_list.print_all_nodes()
    ...
    def test_remove_first(self):
        ...
        test = s_list_remove.print_all_nodes()
        s_list_remove_end = list.LinkedList()
        s_list_remove_end.add_in_tail(n2)
        test1 = s_list_remove_end.print_all_nodes()
        self.assertEqual(test, test1)
    ...
    def test_compare(self):
        ...
        test2 = s_list_compare_end.print_all_nodes()
